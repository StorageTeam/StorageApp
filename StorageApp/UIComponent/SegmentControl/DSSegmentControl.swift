...
protocol DSSegmentControlDelegate {
    func segmentControlDidSelected(control: DSSegmentControl, index: Int) -> Void
}

class DSSegmentControl: UIView {
    ...
    var delegate:DSSegmentControlDelegate?
